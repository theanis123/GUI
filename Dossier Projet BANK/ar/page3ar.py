...
#msg 
label_msg = Label(frm2,text="الرجاء إدخال رقم بطاقة الهوية البيومترية الخاصة بك",font=('Arial',18,"bold"),fg='#095CD3',bg='#F2F7F9')
label_msg.place(x=345,y=25)
...
image = Image.open('ar/image/identite_ar.png')

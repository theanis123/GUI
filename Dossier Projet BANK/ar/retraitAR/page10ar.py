...
lbl_msg = CTkLabel(master=frm2,text='يرجى جمع الأمتعة الخاصة بك',font=('Arial',40,"bold"),text_color='#095CD3',fg_color='#F2F7F9')
lbl_msg.pack(expand=YES,pady=70)

bouton = CTkButton(master=frm2,text='تأكيد',font=('Arial',30),text_color='#F2F7F9',fg_color='#1679EF',height=60,width=200,corner_radius=4)
